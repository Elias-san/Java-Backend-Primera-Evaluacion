...
public alumnos(int idalumnos,String nombre,String apellido,
    ...
    public String toString() {
        return "alumnos{" + "idalumnos=" + idalumnos + ", nombre=" + nombre + ", apellido=" + apellido + ", idtipodedocumento=" + idtipodedocumento + ", dni=" + dni + ", email=" + email + ", celular=" + celular + ", idtiponacionalidad=" + idtiponacionalidad + '}';
    }
